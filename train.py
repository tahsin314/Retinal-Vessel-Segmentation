...
for i in train_files:
    ...
    temp = cv2.resize(cv2.imread(training_label_loc + i.split('_')[0] + '_manual1.tiff', cv2.IMREAD_GRAYSCALE),
                      (512, 512))
...
x_train = np.reshape(x_train, (len(x_train), 512, 512, 1))  # adapt this if using `channels_first` image data format
